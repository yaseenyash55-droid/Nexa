...
CREATE TABLE MESSAGES (
  ...
  IS_UNSENT         NUMBER(1) DEFAULT 0 NOT NULL,
  CREATED_AT        TIMESTAMP WITH TIME ZONE DEFAULT SYSTIMESTAMP NOT NULL,
  ...
  CONSTRAINT CHK_MESSAGES_IS_UNSENT CHECK (IS_UNSENT IN (0, 1))
);
...
CREATE TABLE NOTES (
  ...
  USER_ID          NUMBER NOT NULL,
  CONTENT_TEXT     VARCHAR2(60),
  SPOTIFY_TRACK_ID VARCHAR2(50),
  CREATED_AT       TIMESTAMP WITH TIME ZONE DEFAULT SYSTIMESTAMP NOT NULL,
  EXPIRES_AT       TIMESTAMP WITH TIME ZONE GENERATED ALWAYS AS (CREATED_AT + INTERVAL '24' HOUR) VIRTUAL,
  CONSTRAINT FK_NOTES_USER FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID) ON DELETE CASCADE,
  CONSTRAINT CHK_NOTES_CONTENT CHECK (
    (CONTENT_TEXT IS NOT NULL AND SPOTIFY_TRACK_ID IS NULL) OR
    (CONTENT_TEXT IS NULL AND SPOTIFY_TRACK_ID IS NOT NULL)
  )
);

CREATE INDEX IDX_NOTES_USER_EXPIRE ON NOTES (USER_ID, EXPIRES_AT);
